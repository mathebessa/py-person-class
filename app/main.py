    ...
    def __init__(self,
        ...
        if nome_da_esposa is not None:
            if nome_da_esposa not in Pessoa.pessoas:
                raise ValueError(f"A pessoa {nome_da_esposa} não foi registrada.")
            self.esposa = Pessoa.pessoas[nome_da_esposa]

        if nome_do_marido is not None:
            if nome_do_marido not in Pessoa.pessoas:
                raise ValueError(f"A pessoa {nome_do_marido} não foi registrada.")
...
pessoa1 = Pessoa("John", nome_da_esposa="Jane")
pessoa2 = Pessoa("Jane", nome_do_marido="John")
